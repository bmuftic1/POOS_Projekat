...
f = open("./DeskriptorTest2.csv", "a")
f.write("Hu1,Hu2,Hu3,Hu4,Hu5,Hu6,Hu7\n")

for i in range(0,90):
	try:
		Slika = cv2.imread('./Test2/CroppedROI{}.jpg'.format(i+1))
...
f = open("./DeskriptorTrain2.csv", "a")
f.write("Hu1,Hu2,Hu3,Hu4,Hu5,Hu6,Hu7,Klasa\n")
klasa=1

for i in range(0,90):
	try:
		Slika = cv2.imread('./Train2/CroppedROI{}.jpg'.format(i+1))
